<?php
  /*
   ...
   Plugin URI: http://additifstabac.free.fr/index.php/dailystat-new-statistics-wordpress-plugin/
   Description: Improved real time stats for your blog
   Version: 1.0
   Author: luciole135
   Author URI: http://additifstabac.free.fr/index.php/dailystat-new-statistics-wordpress-plugin/
   */
  
  $_DAILYSTAT['version'] = '1.0';
  $_DAILYSTAT['feedtype'] = '';
  ...
  function iri_add_pages()
  {
      ...
      add_menu_page('Daily stat', 'Daily stat', $mincap, __FILE__, 'iridailystat',WP_CONTENT_URL .'/plugins/daily-stat/images/stat.png');
...
function iri_dailystat_extractfeedreq($url)
{
    ...
    return $res;
      ...
      function iri_dailystat_Vars($body)
      {
          ...
          {
              $qry = $wpdb->get_results("SELECT urlrequested, count(id) as totale FROM $table_name WHERE spider='' AND feed='' AND urlrequested <>'' GROUP BY urlrequested ORDER BY totale DESC LIMIT 1;");
